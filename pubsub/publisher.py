...
class Publisher:
    ...
    Sample usage:
    publisher = Publisher("http://127.0.0.1:5556", "http://127.0.0.1:5555")
    ...
    def __init__(self, address, registration_address):
        ...
        :param str registration_address: address of the broker with which this publisher registers topics. String with
